...
from .models import Funcao, Exame, Risco, TipoRisco, Setor, Grupo, GrupoExame, GrupoFuncao, GrupoRisco, TipoExame
from .models import Coordenador, Empregado, Atendimento, AtendimentoExame, AtendimentoRisco
